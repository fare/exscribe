...
(defmacro define-header-tag (tag)
  `(deftag ,tag nil (align textcolor bgcolor id class dir lang style title)))
...
(deftag body () (color))
(deftag p () ())
(deftag font () (size face color))
(deftag td () (valign width height color bgcolor colspan rowspan))
(deftag th () (valign width height color bgcolor colspan rowspan))
(deftag tr () (valign width height color bgcolor))
(deftag table () (valign width height cellpadding cellspacing border))
...
(deftag span () ())
(deftag div () ())
(deftag address () ()) ;; TODO: add proper attributes
(deftag form () (method action)) ;; TODO: add proper attributes
(deftag input () (type name size maxlength value)) ;; TODO: add proper attributes

(deftag make-document :document (author))
...
(deftag section () (number heading toc refid label))
(deftag subsection () (number heading toc refid label))
(deftag subsubsection () (number heading toc refid label))
